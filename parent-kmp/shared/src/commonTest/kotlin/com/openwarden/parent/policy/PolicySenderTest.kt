...
class PolicySenderTest {
    ...
    @Test
    fun notPairedDoesNotReserveSeq() = runTest {
    ...
    @Test
    fun notProvisionedDoesNotReserveSeq() = runTest {
        val seq = FakePolicySeqStore()
    ...
    @Test
    fun sentOnAppliedCarriesSignedAddressedBundle() = runTest {
    ...
    @Test
    fun rejectedPassesChildReason() = runTest {
    ...
    @Test
    fun transportFailureReturnsSignedBundleForRetry() = runTest {
    ...
    @Test
    fun consecutiveSendsUseDistinctStrictlyIncreasingSeqs() = runTest {
        val seq = FakePolicySeqStore()
    ...
    @Test
    fun resendReusesBundleWithoutNewSeq() = runTest {
        val seq = FakePolicySeqStore()
    ...
    @Test
    fun bundleCarriesConfiguredFreshnessWindow() = runTest {
