...
internal class ApiChildStateRepository(
    ...
    override suspend fun fetchSnapshot(): ChildDashboardSnapshot = runCatching {
        val state = (client.getState() as? ApiResult.Success)?.data
    ...
    internal companion object {
        ...
        fun offline() = ChildDashboardSnapshot(
            reportedAt = null,
         ...
         *   non-null here.
         */
        fun mapToSnapshot(state: ChildStateResponse, usage: List<AppUsageEntry>?): ChildDashboardSnapshot {
            ...
            val todayUsage: TodayUsage = if (usage == null) {
                TodayUsage.Unknown
            } else {
                TodayUsage.Known(
